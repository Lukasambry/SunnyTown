...
<template>
    <!-- TODO: remove the mt-[500px] -->
    <div class="backdrop-blur font-mono gap-2 grid-cols-[auto_150px] inline-grid mt-[500px] p-2 rounded-lg w-fit">
        <!-- Colonne 1: Avatar et niveau -->
...
<style scoped>
/* Classes personnalisées qui ne peuvent pas être remplacées par Tailwind */
.text-shadow {
